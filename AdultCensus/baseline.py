...
class Baseline:
    def __init__(self, train, val, val_data_dict, data_num_array, num_class, num_label, slice_index, add_data_dict, method):
        """
        Args:
    ...
    def fc_training(self, process_num):
        """ 
        ...
        network = FC(self.train[0], self.train[1], self.val[0], self.val[1], self.val_data_dict, 
        ...
        loss_dict, slice_num, process_num = network.fc_train(process_num)
    ...
    def train_after_collect_data(self, num_examples, num_iter):
        ...
        with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
            ...
            for i in range(num_iter):
                batch_jobs.append(executor.submit(self.fc_training, i))
