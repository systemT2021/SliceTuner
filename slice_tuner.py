...
class SliceTuner:
        ...
        for i in range(num_iter):
            with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
                ...
                for k in range(len(num_k)):
                    batch_jobs.append(executor.submit(self.cnn_training, num_k, k))
    ...
    def train_after_collect_data(self, num_examples, num_iter):
        ...
        with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
            batch_jobs = []
            for i in range(num_iter):
                batch_jobs.append(executor.submit(self.cnn_training, num_k, i))
    ...
    def cnn_training(self, num_k, k):
        ...
        loss_dict, slice_num, process_num = network.cnn_train(k)
